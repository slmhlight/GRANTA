...
// R226t 작문회차: aisi-420·cp-ti 재연결, aisi-4340·astm-a36-structural·wc-6co 삭제(개념중복).
// H6 W3 리뷰: epdm/fkm 의 "DB 에 재료 없음" 이 해소됐다 — POL-0134(EPDM)·POL-0135(FKM) 를 추가하고
//   두 스토리를 v2 로 격상해 연결. dead 는 이제 0 이며, 새 dead 가 생기면 곧바로 실패한다.
const DOCUMENTED_DEAD = new Set<string>([]);
