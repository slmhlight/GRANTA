...
export const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  'filter.density': { ko: '밀도', en: 'Density' },
  'filter.yieldStrength': { ko: '항복강도', en: 'Yield Strength' },
  'filter.uts': { ko: 'UTS', en: 'UTS' },
  'filter.elongation': { ko: '연신율', en: 'Elongation' },
  'filter.modulus': { ko: '탄성계수', en: "Young's Modulus" },
  'filter.hardness': { ko: '경도', en: 'Hardness' },
  'filter.popularity': { ko: '인기도', en: 'Popularity' },
  'filter.family': { ko: '소재 패밀리', en: 'Family' },
  'filter.fatigueStrength': { ko: '피로 한도', en: 'Fatigue Strength' },
  'filter.impactStrength': { ko: '충격 인성', en: 'Impact (Charpy)' },
  'filter.thermalConductivity': { ko: '열전도도', en: 'Thermal Conductivity' },
  'filter.electricalConductivity': { ko: '전기전도도', en: 'Electrical Conductivity' },
  'filter.maxServiceTemp': { ko: '최대 사용 온도', en: 'Max Service Temp' },
  'filter.price': { ko: '단가', en: 'Price' },
  'filter.thermalExpansion': { ko: '열팽창', en: 'Thermal Expansion (CTE)' },
  'filter.meltingPoint': { ko: '용융점', en: 'Melting / Liquidus' },
  'filter.specificHeat': { ko: '비열', en: 'Specific Heat' },
  'filter.poissonRatio': { ko: '푸아송비', en: "Poisson's Ratio" },
  'filter.fractureToughness': { ko: '파괴 인성', en: 'Fracture Toughness' },
  'filter.totalCost': { ko: '총 추정 단가', en: 'Total Cost (est.)' },
  'filter.machiningFactor': { ko: '가공 비용 가중치', en: 'Machining factor' },
  'filter.htFactor': { ko: '열처리 비용 가중치', en: 'HT factor' },
  'filter.minWall': { ko: '최소 벽 두께', en: 'Min wall' },
  'filter.surfaceRa': { ko: '표면 거칠기', en: 'Surface Ra' },
  'filter.corrosion': { ko: '내식성', en: 'Corrosion resistance' },
  'filter.machinability': { ko: '가공성', en: 'Machinability' },
  'filter.weldability': { ko: '용접성', en: 'Weldability' },
