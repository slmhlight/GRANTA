...
export const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  'banner.firstCandidate': { ko: '첫 후보', en: 'Top pick' },
  'banner.firstCandidateTip': { ko: '첫 후보 상세 보기', en: 'Open top-pick detail' },
  'banner.openCompareTip': { ko: 'Compare 패널 열기', en: 'Open Compare panel' },
  'banner.switchViewTip': { ko: '권장 뷰로 전환', en: 'Switch to recommended view' },
  ...
  'detail.section.costEstimate': { ko: '(핸드북 추정)', en: '(handbook estimate)' },
  ...
  'query.help.naturalKo': { ko: '자연어 (한국어)', en: 'Natural language (Korean)' },
  'home.cardsHint.title': { ko: '모바일에서는 Cards 뷰가 보기 편함', en: 'Cards view works better on mobile' },
  'home.cardsHint.desc': { ko: '가로 스크롤 없이 한 줄씩 — 하단 바의 뷰 토글로 전환.', en: 'One row at a time, no horizontal scroll — switch via the bottom bar toggle.' },
  'home.cardsHint.action': { ko: 'Cards 로 전환', en: 'Switch to Cards' },
