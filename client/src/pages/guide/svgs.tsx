...
export const SvgBracket = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="90" y="50" fontSize="10" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">F</text>
  </svg>
);
export const SvgManifold = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="10" y="80" fontSize="9" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">~700°C</text>
  </svg>
);
export const SvgShaft = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="14" y="80" fontSize="9" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">±σ 반복</text>
  </svg>
);
export const SvgPrecision = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="89" y="80" fontSize="9" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">ΔT</text>
    ...
    <text x="38" y="86" fontSize="8" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">ΔL ≈ 0</text>
  </svg>
);
export const SvgMarine = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="20" y="86" fontSize="8" className="fill-sky-600 svg-text-bg-sm" fontFamily="monospace">Cl⁻ · NaCl</text>
  </svg>
);
export const SvgLowcost = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="92" y="46" fontSize="22" className="fill-emerald-600 svg-text-bg-sm" fontFamily="serif" fontWeight="bold">$</text>
    <text x="86" y="64" fontSize="8" className="fill-foreground/60 svg-text-bg-sm" fontFamily="monospace">×10⁵</text>
  </svg>
);
export const SvgSpring = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="44" y="82" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">σy² / E ↑</text>
  </svg>
);
...
export const SvgWear = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="14" y="80" fontSize="9" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">Hertz · HV ↑</text>
  </svg>
);
export const SvgMedical = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="14" y="84" fontSize="8" className="fill-emerald-600 svg-text-bg-sm" fontFamily="monospace">Ti / CoCr / 316L</text>
  </svg>
);
export const SvgCryogenic = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="22" y="56" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">LNG</text>
    <text x="22" y="68" fontSize="8" className="fill-sky-700 svg-text-bg-sm" fontFamily="monospace">−162°C</text>
    {/* 눈송이 */}
...
export const SvgElectrical = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="20" y="48" fontSize="9" className="fill-foreground/80 svg-text-bg-sm" fontFamily="monospace">Cu 100A</text>
    {/* 번개 */}
    <path d="M 100 18 L 92 38 L 100 38 L 96 58 L 110 32 L 102 32 L 108 18 Z" className="fill-amber-500" stroke="none" />
    <text x="14" y="80" fontSize="9" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">I²R · ΔT</text>
  </svg>
);
...
export const SvgPressureVesselSmall = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="60" y="46" fontSize="10" textAnchor="middle" className="fill-rose-500 font-bold svg-text-bg-sm" fontFamily="monospace">P</text>
    <text x="12" y="80" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">σ_h = PD/2t</text>
  </svg>
);
export const SvgGear = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="14" y="80" fontSize="9" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">T · F_t</text>
  </svg>
);
export const SvgFastener = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="14" y="84" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">UTS · σy · 등급</text>
  </svg>
);
export const SvgDieMold = () => (
  <svg viewBox="0 0 120 90" className="w-full h-full">
    ...
    <text x="60" y="14" textAnchor="middle" fontSize="8" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">HV ≥ 600 · 인성</text>
  </svg>
);
...
export const SvgRect = () => (
  <svg viewBox="0 0 90 80" className="w-full h-full">
    ...
    <text x="40" y="78" fontSize="11" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">b</text>
    <text x="73" y="44" fontSize="11" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">h</text>
  </svg>
);
export const SvgSquare = () => (
  <svg viewBox="0 0 90 80" className="w-full h-full">
    ...
    <text x="42" y="78" fontSize="11" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">a</text>
  </svg>
);
export const SvgCircle = () => (
  <svg viewBox="0 0 90 80" className="w-full h-full">
    ...
    <line x1="14" y1="40" x2="76" y2="40" strokeDasharray="3 2" className="stroke-foreground/40"/>
    <text x="42" y="78" fontSize="11" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">d</text>
  </svg>
);
export const SvgBox = () => (
  <svg viewBox="0 0 90 80" className="w-full h-full">
    ...
    <text x="36" y="78" fontSize="10" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">B,b</text>
  </svg>
);
export const SvgTube = () => (
  <svg viewBox="0 0 90 80" className="w-full h-full">
    ...
    <text x="40" y="78" fontSize="10" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">D,d</text>
  </svg>
);
export const SvgIBeam = () => (
  <svg viewBox="0 0 90 80" className="w-full h-full">
    ...
    <text x="32" y="78" fontSize="10" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">I-빔</text>
  </svg>
);
...
export const SvgColumn = () => (
  <svg viewBox="0 0 120 100" className="w-full h-full">
    ...
    <text x="48" y="8" fontSize="12" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">P</text>
  </svg>
);
...
export const SvgStressStrain = () => (
  <svg viewBox="0 0 320 215" className="w-full h-full">
    ...
    <text x="20" y="22" fontSize="11" className="fill-foreground font-semibold svg-text-bg-sm">σ</text>
    <text x="306" y="178" fontSize="11" className="fill-foreground font-semibold svg-text-bg-sm">ε</text>
    ...
    <text x="248" y="148" fontSize="10" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">파단</text>
    ...
    <text x="18" y="74" fontSize="11" className="fill-emerald-600 font-bold svg-text-bg-sm">σy</text>
    ...
    <text x="14" y="44" fontSize="11" className="fill-violet-600 font-bold svg-text-bg-sm">UTS</text>
    <text x="58" y="120" fontSize="10" className="fill-amber-600 font-semibold svg-text-bg-sm">E = 기울기 (강성)</text>
    ...
    <text x="80" y="208" fontSize="10" className="fill-sky-600 font-semibold svg-text-bg-sm">연신율 (파단 변형률)</text>
    <text x="55" y="155" fontSize="9" className="fill-foreground/60 svg-text-bg-sm">탄성</text>
    <text x="115" y="55" fontSize="9" className="fill-foreground/60 svg-text-bg-sm">소성(가공경화)</text>
    <text x="226" y="55" fontSize="9" className="fill-foreground/60 svg-text-bg-sm">네킹</text>
  </svg>
);

/* R190 — viewBox 180→200, σ_max label 사각형 outside, formula 2 줄. */
export const SvgBendingStress = () => (
  <svg viewBox="0 0 320 200" className="w-full h-full">
    <text x="6" y="14" fontSize="10" className="fill-foreground/70 font-semibold svg-text-bg-sm">① 굽힘 받은 보</text>
    ...
    <text x="20" y="34" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">M</text>
    <text x="138" y="34" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">M</text>
    <text x="172" y="14" fontSize="10" className="fill-foreground/70 font-semibold svg-text-bg-sm">② 단면 + 응력 분포</text>
    ...
    <text x="168" y="94" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" textAnchor="end">중립축</text>
    ...
    {/* R190 — σ_max labels 사각형 outside (x=286), svg-text-bg white outline 으로 가독성 보장 */}
    <text x="286" y="34" fontSize="9" className="fill-rose-500 font-semibold svg-text-bg">σ_max</text>
    <text x="290" y="46" fontSize="8" className="fill-rose-500 svg-text-bg-sm">(압축)</text>
    <text x="286" y="150" fontSize="9" className="fill-sky-500 font-semibold svg-text-bg">σ_max</text>
    <text x="290" y="162" fontSize="8" className="fill-sky-500 svg-text-bg-sm">(인장)</text>
    ...
    <text x="160" y="62" fontSize="10" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">c</text>
    {/* formula 2 줄 분리 — viewBox 320 width 안 가독성 확보 */}
    <text x="6" y="180" fontSize="11" className="fill-foreground font-mono svg-text-bg-sm">σ_max = M · c / I</text>
    <text x="6" y="195" fontSize="10" className="fill-foreground/70 svg-text-bg-sm">→ I 가 크면 σ가 작아짐</text>
  </svg>
);
...
export const SvgTorsion = () => (
  <svg viewBox="0 0 320 160" className="w-full h-full">
    <text x="6" y="14" fontSize="10" className="fill-foreground/70 font-semibold svg-text-bg-sm">① 토크 T 작용</text>
    ...
    <text x="142" y="32" fontSize="11" className="fill-rose-500 font-bold svg-text-bg-sm" fontFamily="monospace">T</text>
    ...
    <text x="186" y="14" fontSize="10" className="fill-foreground/70 font-semibold svg-text-bg-sm">② 단면 전단응력</text>
    ...
    <text x="296" y="84" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">c=D/2</text>
    <text x="244" y="138" fontSize="10" className="fill-rose-600 font-bold svg-text-bg-sm" fontFamily="monospace">τ_max = T·c/J</text>
    <text x="248" y="152" fontSize="9" className="fill-foreground/70 italic svg-text-bg-sm">중심: τ=0</text>
  </svg>
);
...
export const SvgMohr = () => (
  <svg viewBox="0 0 320 180" className="w-full h-full">
    <text x="6" y="14" fontSize="10" className="fill-foreground/70 font-semibold svg-text-bg-sm">① 응력 요소</text>
    ...
    <text x="0" y="86" fontSize="11" className="fill-sky-700 font-bold svg-text-bg-sm" fontFamily="monospace">σx</text>
    <text x="105" y="86" fontSize="11" className="fill-sky-700 font-bold svg-text-bg-sm" fontFamily="monospace">σx</text>
    ...
    <text x="56" y="32" fontSize="10" className="fill-rose-500 font-bold svg-text-bg-sm" fontFamily="monospace">τ</text>
    <text x="170" y="14" fontSize="10" className="fill-foreground/70 font-semibold svg-text-bg-sm">② Mohr 원</text>
    ...
    <text x="312" y="98" fontSize="10" className="fill-foreground/70 font-mono svg-text-bg-sm">σ</text>
    <text x="244" y="40" fontSize="10" className="fill-foreground/70 font-mono svg-text-bg-sm">τ</text>
    ...
    <text x="284" y="118" fontSize="9" className="fill-violet-700 font-mono svg-text-bg-sm">σ₁</text>
    <circle cx="222" cy="100" r="3" className="fill-violet-600" />
    <text x="208" y="118" fontSize="9" className="fill-violet-700 font-mono svg-text-bg-sm">σ₂</text>
    <circle cx="258" cy="64" r="3" className="fill-rose-500" />
    <text x="262" y="62" fontSize="9" className="fill-rose-500 font-mono svg-text-bg-sm">τ_max</text>
    <text x="170" y="172" fontSize="10" className="fill-foreground font-mono svg-text-bg-sm">σ_eq = √(σx² + 3τ²) ≤ σy/SF</text>
  </svg>
);
...
export const SvgPressureVessel = () => (
  <svg viewBox="0 0 320 160" className="w-full h-full">
    ...
    <text x="125" y="84" fontSize="10" className="fill-rose-500 font-bold svg-text-bg-sm" fontFamily="monospace">p</text>
    ...
    <text x="84" y="30" fontSize="10" className="fill-violet-700 font-semibold svg-text-bg-sm">σ_h (후프)</text>
    ...
    <text x="14" y="98" fontSize="10" className="fill-emerald-700 font-semibold svg-text-bg-sm">σ_a (축)</text>
    <text x="222" y="98" fontSize="10" className="fill-emerald-700 font-semibold svg-text-bg-sm">σ_a</text>
    <g className="stroke-foreground/50" strokeWidth="1" fill="none"><line x1="200" y1="80" x2="200" y2="120" /></g>
    <text x="204" y="105" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">r</text>
    <text x="246" y="80" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">t (얇음)</text>
    <text x="22" y="148" fontSize="11" className="fill-foreground font-mono svg-text-bg-sm">σ_h = p·r/t · σ_a = p·r/(2t)</text>
  </svg>
);
...
export const IconYield = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="38" y="14" fontSize="10" className="fill-emerald-600 font-bold svg-text-bg-sm" fontFamily="monospace">σy</text>
  </svg>
);
export const IconUTS = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="52" y="14" fontSize="9" className="fill-violet-600 font-bold svg-text-bg-sm" fontFamily="monospace">UTS</text>
  </svg>
);
export const IconElongation = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="14" y="10" fontSize="8" className="fill-rose-500 svg-text-bg-sm">취성</text>
    <path d="M 10 42 L 30 24 Q 40 22 58 22 L 62 38" fill="none" className="stroke-emerald-600" strokeWidth="2" />
    <text x="46" y="18" fontSize="8" className="fill-emerald-600 svg-text-bg-sm">연성</text>
  </svg>
);
export const IconE = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="18" y="14" fontSize="8" className="fill-amber-600 svg-text-bg-sm">E ↑</text>
    <line x1="10" y1="42" x2="70" y2="30" className="stroke-sky-600" strokeWidth="2" />
    <text x="50" y="38" fontSize="8" className="fill-sky-600 svg-text-bg-sm">E ↓</text>
  </svg>
);
export const IconHardness = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="56" y="26" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">HV</text>
  </svg>
);
export const IconFatigue = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="2" y="10" fontSize="7" className="fill-foreground/60 svg-text-bg-sm">σ_a</text>
    <text x="68" y="50" fontSize="7" className="fill-foreground/60 svg-text-bg-sm">log N</text>
    ...
    <text x="46" y="30" fontSize="7" className="fill-rose-500 svg-text-bg-sm">한도</text>
  </svg>
);
export const IconDensity = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="64" y="42" fontSize="9" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">ρ</text>
  </svg>
);
export const IconCTE = () => (
  <svg viewBox="0 0 80 50" className={_box}>
    ...
    <text x="42" y="58" fontSize="7" className="fill-foreground/70 svg-text-bg-sm">ΔL</text>
    <text x="62" y="10" fontSize="8" className="fill-rose-500 font-bold svg-text-bg-sm">+ΔT</text>
  </svg>
);
export const IconK = () => (
  <svg viewBox="0 0 80 50" className={_box}>
...
export const SvgCantileverV2 = () => (
  <svg viewBox="0 0 200 90" className="w-full h-full">
    ...
    <text x="184" y="58" fontSize="11" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">F</text>
    ...
    <text x="98" y="52" fontSize="9" className="fill-emerald-700 font-bold svg-text-bg-sm" fontFamily="monospace">δ_max</text>
    <text x="92" y="86" fontSize="11" className="fill-foreground/70 svg-text-bg-sm" fontFamily="monospace">L</text>
  </svg>
);
export const SvgCantileverUDLV2 = () => (
  <svg viewBox="0 0 200 90" className="w-full h-full">
    ...
    {udl(28, 180)}
    <text x="94" y="14" fontSize="12" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">w</text>
    ...
    <text x="150" y="72" fontSize="9" className="fill-emerald-700 font-bold svg-text-bg-sm" fontFamily="monospace">δ_max</text>
  </svg>
);
export const SvgSimpleCenterV2 = () => (
  <svg viewBox="0 0 200 90" className="w-full h-full">
    ...
    <text x="92" y="11" fontSize="12" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">F</text>
    ...
    <text x="110" y="48" fontSize="9" className="fill-emerald-700 font-bold svg-text-bg-sm" fontFamily="monospace">δ_max</text>
  </svg>
);
export const SvgSimpleUDLV2 = () => (
  <svg viewBox="0 0 200 90" className="w-full h-full">
    ...
    <polygon points="186,38 178,52 194,52" className={`fill-foreground/30 ${stroke}`} strokeWidth="1"/>
    {udl(22, 180)}
    <text x="94" y="11" fontSize="12" className="fill-rose-500 svg-text-bg-sm" fontFamily="monospace">w</text>
...
export const SvgFixedCenterV2 = () => (
  <svg viewBox="0 0 200 90" className="w-full h-full">
    ...
    <text x="112" y="48" fontSize="9" className="fill-emerald-700 font-bold svg-text-bg-sm" fontFamily="monospace">δ_max</text>
  </svg>
);
export const SvgFixedUDLV2 = () => (
  <svg viewBox="0 0 200 90" className="w-full h-full">
    ...
    <text x="110" y="46" fontSize="9" className="fill-emerald-700 font-bold svg-text-bg-sm" fontFamily="monospace">δ_max</text>
  </svg>
);
