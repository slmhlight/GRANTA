...
- **1,133 materials** total — live counts in `client/public/build-meta.json` (SSOT). By category: 927 Metal · 133 Polymer · 39 Ceramic · 34 Composite. (R227/H4d: +4 백주철·ADI (`data/alloy-additions.json` — supRaw **최후미 합류·지정 append 지점**, ASTM A532/A897 검증값) → 1133.) (R226b: 1198→1107; R226c: +7 cast → 1114; R226d: −2 dup → 1112; R226j: +1 ADC12 → 1113; R226l: +11 Granta → 1124; R226m: +5 → 1129.)
