...
> **2026-07 사용자 피드백 20건 반영 상세 실행 계획 → [GLOSSARY-IMPROVEMENT-PLAN.md](GLOSSARY-IMPROVEMENT-PLAN.md)** (분량 A4 2~3장·용어 영어원문 우선·Normalizing 오역 수정·도표 전용화·미세조직 Voronoi 다각형·신규 용어·문서별 확장·절삭성/용접성 산문화. Phase 0~7). 아래는 요약.
