...
| 질화(?!물|텅스텐) | Nitriding | 글로서리 A4 (data/glossary-articles.json) | 12 |  | 기고, 반대로 표면을 매끄럽게 하거나 숏피닝·침탄·질화로 표면에 압축 잔류응력을 넣으면 수명이 크게 늘어난다 |
...
| 오스템퍼링 | Austempering | 글로서리 A4 (data/glossary-articles.json) | 7 |  | 도를 고르게 한 뒤 서랭하여 변태 응력을 낮춘다. 오스템퍼링(austempering)은 아예 베이나이트로 변 |
...
| 오스테나이트화 | Austenitizing | 글로서리 정의 (data/glossary.json) | 2 |  |  ], "short": "오스테나이트화한 강을 물·기름 등으로 급랭하여 마르텐사이트 |
